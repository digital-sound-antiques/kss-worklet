...
import { AudioRendererWorkletRequest, AudioRendererWorkletResponse } from "./workers/audio-renderer-worklet-processor";
...
export class AudioRenderer {
  ...
  static create(type: AudioRendererType, context: BaseAudioContext, workletName?: string | null): AudioRenderer {
    if (type == 'worklet') {
      return new AudioRenderer(new WorkletRenderer(context, workletName ?? 'renderer'));
    } else if (type == 'script') {
      return new AudioRenderer(new ScriptRenderer(context));
    } else {
...
class WorkletRenderer implements AudioRendererDelegate {
  ...
  constructor(audioContext: BaseAudioContext, workletName: string) {
  ...
  _completerMap: { [key: number]: (res: AudioRendererWorkletResponse) => void } = {};
...
class ScriptRenderer implements AudioRendererDelegate {
  ...
  constructor(audioContext: BaseAudioContext) {
    ...
    this._buffer = new WaveBuffer(audioContext.sampleRate);
  }
